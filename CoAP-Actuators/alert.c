...
#define NODE_NAME_JSON "{\"name\":\"actuator_alert\",\"status\":\"off\"}"
...
void client_chunk_handler(coap_message_t *response){
    ...
    if(response == NULL){
        ...
        LOG_INFO("Registrazione alert riuscita!\n");
...
PROCESS(alert_thread, "alert");
AUTOSTART_PROCESSES(&alert_thread);
...
PROCESS_THREAD(alert_thread, ev, data){
    ...
    coap_activate_resource(&res_alert, "actuator_alert");
